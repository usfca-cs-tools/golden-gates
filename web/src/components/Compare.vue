...
export default defineComponent({
  ...
  computed: {
    // Fixed size - 4x6 grid units (2 inputs, 3 outputs)
    width() {
      return 4
    },
    height() {
    ...
    ltOutputY() {
      return GRID_SIZE * 1 // 1 grid unit from top (less than)
    },
    eqOutputY() {
      return GRID_SIZE * 3 // 3 grid units from top (equal)
    },
    gtOutputY() {
      return GRID_SIZE * 5 // 5 grid units from top (greater than)
    },
    // Label positions
    inputLabelX() {
